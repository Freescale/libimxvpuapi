 ...
 * addresses, then the physical address returned by @map must be set to zero.
 *
 * The vfuncs are:
 *
...
typedef enum
{
	...
	IMX_VPU_DEC_OUTPUT_CODE_NO_DECODED_PICTURE_AVAILABLE = (1UL << 3), // TODO: remove this (makes no sense; absence of IMX_VPU_DEC_OUTPUT_CODE_DECODED_PICTURE_AVAILABLE already implies no picture available)
